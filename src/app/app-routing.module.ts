...
const routes: Routes = [
  ...
  {path : 'signup', title: "PersonalBook - Sign Up", component: SignupComponent},
  {path : 'login', title: "PersonalBook - Log In", component: LoginComponent},
  {path : 'finance', title:"PersonalBook - Finance" , component: FinanceComponent, canActivate: [AuthGuard]},
  {path : 'home', component : HomeComponent, canActivate: [AuthGuard]},
  {path : 'education', title: "PersonalBook - Education",  component : EducationComponent, canActivate: [AuthGuard]},
  {path : 'profile',  component:ProfileComponent, canActivate:[AuthGuard]},
  {path : 'grade', title:"PersonalBook - Grade", component: GradeListComponent, canActivate:[AuthGuard] },
